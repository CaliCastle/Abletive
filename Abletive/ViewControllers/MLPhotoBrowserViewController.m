...
-(void)setPageLabelPage:(NSInteger)page{
    self.pageLabel.text = [NSString stringWithFormat:@"%lu / %lu",(unsigned long)page + 1, (unsigned long)self.photos.count];
}
...
- (void)pickerPhotoScrollViewDidLongPress:(UIAlertController *)alertController {
