...
+ (void)showOverlayWithLogo {
    [TAOverlay showOverlayWithLabel:@"正在加载中...请稍候" ImageArray:[NSArray arrayWithObjects:[UIImage imageNamed:@"logo-loading-01"],[UIImage imageNamed:@"logo-loading-02"],[UIImage imageNamed:@"logo-loading-03"],[UIImage imageNamed:@"logo-loading-04"], [UIImage imageNamed:@"logo-loading-05"], [UIImage imageNamed:@"logo-loading-06"], [UIImage imageNamed:@"logo-loading-07"], [UIImage imageNamed:@"logo-loading-08"], [UIImage imageNamed:@"logo-loading-09"], [UIImage imageNamed:@"logo-loading-10"], [UIImage imageNamed:@"logo-loading-11"], [UIImage imageNamed:@"logo-loading-12"], [UIImage imageNamed:@"logo-loading-13"], [UIImage imageNamed:@"logo-loading-14"], [UIImage imageNamed:@"logo-loading-15"], [UIImage imageNamed:@"logo-loading-16"], [UIImage imageNamed:@"logo-loading-17"], [UIImage imageNamed:@"logo-loading-18"], [UIImage imageNamed:@"logo-loading-19"], [UIImage imageNamed:@"logo-loading-20"], nil] Duration:0.9 Options:TAOverlayOptionOverlaySizeRoundedRect | TAOverlayOptionOpaqueBackground | TAOverlayOptionOverlayShadow];
}

+ (void)showOverlayWithLogoAndLabel:(NSString *)text {
    [TAOverlay showOverlayWithLabel:text ImageArray:[NSArray arrayWithObjects:[UIImage imageNamed:@"logo-loading-01"],[UIImage imageNamed:@"logo-loading-02"],[UIImage imageNamed:@"logo-loading-03"],[UIImage imageNamed:@"logo-loading-04"], [UIImage imageNamed:@"logo-loading-05"], [UIImage imageNamed:@"logo-loading-06"], [UIImage imageNamed:@"logo-loading-07"], [UIImage imageNamed:@"logo-loading-08"], [UIImage imageNamed:@"logo-loading-09"], [UIImage imageNamed:@"logo-loading-10"], [UIImage imageNamed:@"logo-loading-11"], [UIImage imageNamed:@"logo-loading-12"], [UIImage imageNamed:@"logo-loading-13"], [UIImage imageNamed:@"logo-loading-14"], [UIImage imageNamed:@"logo-loading-15"], [UIImage imageNamed:@"logo-loading-16"], [UIImage imageNamed:@"logo-loading-17"], [UIImage imageNamed:@"logo-loading-18"], [UIImage imageNamed:@"logo-loading-19"], [UIImage imageNamed:@"logo-loading-20"], nil] Duration:0.9 Options:TAOverlayOptionOverlaySizeRoundedRect | TAOverlayOptionOpaqueBackground | TAOverlayOptionOverlayShadow];
}

+ (void)showOverlayWithError {
    [TAOverlay showOverlayWithLabel:NSLocalizedString(@"加载错误", nil) Options:TAOverlayOptionAutoHide | TAOverlayOptionOverlayTypeError | TAOverlayOptionOverlaySizeRoundedRect];
}

+ (void)showOverlayWithErrorText:(NSString *)text {
    [TAOverlay showOverlayWithLabel:NSLocalizedString(text, nil) Options:TAOverlayOptionAutoHide | TAOverlayOptionOverlayTypeError | TAOverlayOptionOverlaySizeRoundedRect];
}

+ (void)showOverlayWithLoading {
    [TAOverlay showOverlayWithLabel:NSLocalizedString(@"加载中...", nil) Options:TAOverlayOptionOpaqueBackground | TAOverlayOptionOverlaySizeRoundedRect | TAOverlayOptionOverlayTypeActivityDefault | TAOverlayOptionOverlayDismissTap];
}

+ (void)showOverlayWithSuccessText:(NSString *)text {
    [TAOverlay showOverlayWithLabel:text Options:TAOverlayOptionAutoHide | TAOverlayOptionOverlayTypeSuccess];
}
